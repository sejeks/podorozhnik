  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p>Also use app <a target='blank' href="https://play.google.com/store/apps/details?id=org.plantainreader&hl=ru" >
          Plantain reader</a> to see how many times use used you card.</p>
